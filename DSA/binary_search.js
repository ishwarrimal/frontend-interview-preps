...
// Explaination : 
// Binary Search is applied to a sorted array or list. It's a divide-and-conquer algorithm that efficiently finds the position of a target element in the array. 
// Binary Search is a highly efficient algorithm for searching in sorted data, with a time complexity of O(log n), where n is the size of the array.
...
var findPeakElement = function(nums) {
    ...
    while(left < right) {
        ...
        if (nums[mid] > nums[mid+1]) {
            //we are in the decreasing part of array
            right = mid;
        } else {
